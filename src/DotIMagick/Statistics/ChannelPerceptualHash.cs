...
public partial class ChannelPerceptualHash : IChannelPerceptualHash
{
    ...
    [Obsolete(
        "Will be removed in the next major release, use HuPhash(ColorSpace.sRGB, index) instead."
    )]
    public double SrgbHuPhash(int index) => HuPhash(ColorSpace.sRGB, index);
    ...
    [Obsolete(
        "Will be removed in the next major releas, use HuPhash(ColorSpace.HCLp, index) instead."
    )]
    public double HclpHuPhash(int index) => HuPhash(ColorSpace.HCLp, index);
    ...
    public double SumSquaredDistance(IChannelPerceptualHash other)
    {
        ...
        {
            var otherHuPhashList = otherChannelPerceptualHash?.GetHuPhashListByColorSpace(
                huPhashList.ColorSpace
            );
    ...
    private void AddHuPhash(
        NativeChannelPerceptualHash instance,
