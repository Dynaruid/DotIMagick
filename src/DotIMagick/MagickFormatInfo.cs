...
public sealed partial class MagickFormatInfo : IMagickFormatInfo
{
    ...
    public override int GetHashCode() => ModuleFormat.GetHashCode();
    ...
    private static void AddStealthCoders(
        NativeMagickFormatInfo instance,
        Dictionary<MagickFormat, IMagickFormatInfo> formats
    )
    {
