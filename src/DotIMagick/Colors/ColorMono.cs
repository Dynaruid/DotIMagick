...
public sealed class ColorMono : ColorBase
{
    ...
    /// </summary>
    public static ColorMono Black => new ColorMono(true);

    /// <summary>
    /// Gets a new instance of the <see cref="ColorMono"/> class that is white.
    /// </summary>
    public static ColorMono White => new ColorMono(false);
    ...
    public static explicit operator ColorMono?(MagickColor color) => FromMagickColor(color);
