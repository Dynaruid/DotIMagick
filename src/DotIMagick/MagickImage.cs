...
public sealed partial class MagickImage : IMagickImage<QuantumType>, INativeInstance
{
    ...
    public IChromaticityInfo Chromaticity
    {
        ...
        {
            if (
                _nativeInstance.ChromaRed is null
    ...
    /// </summary>
    [Obsolete(
        $"This property will be removed in the next major release, use {nameof(Chromaticity)} instead."
    )]
    ...
    public Density Density
    {
        get =>
            new Density(
                _nativeInstance.ResolutionX,
                _nativeInstance.ResolutionY,
                _nativeInstance.ResolutionUnits
            );
        set
        {
            if (value is null)
    ...
    /// </summary>
    [Obsolete(
        "Will be removed in the next major release, use MagickFormatInfo.Create(image.Format) instead."
    )]
    public IMagickFormatInfo? FormatInfo => MagickFormatInfo.Create(Format);
    ...
    public Interlace Interlace
    {
        ...
        [Obsolete(
            $"The setter will be removed in the next major release, use Settings.{nameof(Interlace)} instead."
        )]
        set
        {
    ...
    public IMagickGeometry Page
    {
        ...
        set { _nativeInstance.Page = MagickRectangle.FromGeometry(value, this); }
    }
    ...
    /// </summary>
    public IMagickSettings<QuantumType> Settings => _settings;
    ...
    private bool HasColorProfile => HasProfile("icc") || HasProfile("icm");
    ...
    public void AffineTransform(IDrawableAffine affineMatrix)
    {
        ...
        _nativeInstance.AffineTransform(
            affineMatrix.ScaleX,
            affineMatrix.ScaleY,
            affineMatrix.ShearX,
            affineMatrix.ShearY,
    ...
    public IMagickImage<QuantumType> Clone() => new MagickImage(this);
    ...
    public IMagickImage<QuantumType> Clone(IMagickGeometry geometry)
    {
        ...
        clone.SetInstance(
            new NativeMagickImage(_nativeInstance.CloneArea(geometry.Width, geometry.Height))
        );
    ...
    public void Colorize(
        ...
        Percentage alphaRed,
        Percentage alphaGreen,
        Percentage alphaBlue
    )
    {
        Throw.IfNull(nameof(color), color);

        var blend = string.Format(
    ...
    public void ColorThreshold(
        IMagickColor<QuantumType> startColor,
        IMagickColor<QuantumType> stopColor
    )
    {
    ...
    {
        var settings = new ConnectedComponentsSettings { Connectivity = connectivity, };
    ...
    )
    {
        ...
        _nativeInstance.CopyPixels(
            source,
            MagickRectangle.FromGeometry(geometry, this),
            new OffsetInfo(x, y),
            channels
        );
    }
    ...
    public void Evaluate(
        ...
        _nativeInstance.EvaluateGeometry(
            channels,
            MagickRectangle.FromGeometry(geometry, this),
            evaluateOperator,
            value
    ...
    public void Extent(
        ...
        int height,
        Gravity gravity,
        IMagickColor<QuantumType> backgroundColor
    ...
    public void ImportPixels(byte[] data, int offset, IPixelImportSettings settings)
    {
        ...
        Throw.IfTrue(
            nameof(offset),
            offset >= data.Length,
            "The offset should not exceed the length of the array."
        );
        Throw.IfNull(nameof(settings), settings);
        Throw.IfNullOrEmpty(
            nameof(settings),
            settings.Mapping,
            "Pixel storage mapping should be defined."
        );
        Throw.IfTrue(
            nameof(settings),
            settings.StorageType == StorageType.Undefined,
            "Storage type should not be undefined."
        );
        ...
        Throw.IfTrue(
            ...
            "The data length is {0} but should be at least {1}.",
            data.Length,
            expectedLength + offset
        );

        _nativeInstance.ImportPixels(
            settings.X,
            settings.Y,
            settings.Width,
            settings.Height,
    ...
    public void ImportPixels(QuantumType[] data, int offset, IPixelImportSettings settings)
    {
        ...
        Throw.IfTrue(
            nameof(settings),
            settings.StorageType != StorageType.Quantum,
            $"Storage type should be {nameof(StorageType.Quantum)}."
        );
    ...
    public void InverseLevel(Percentage blackPointPercentage, Percentage whitePointPercentage) =>
        InverseLevel(
            ...
            PercentageHelper.ToQuantumType(whitePointPercentage)
        );
    ...
    public void LinearStretch(Percentage blackPoint, Percentage whitePoint) =>
        _nativeInstance.LinearStretch(
            ...
            PercentageHelper.ToQuantum(whitePoint)
        );
    ...
    public IPerceptualHash? PerceptualHash(params ColorSpace[] colorSpaces)
    {
        ...
        temporaryDefines.SetArtifact(
            "phash:colorspaces",
            string.Join(",", colorSpaces.Select(colorSpace => colorSpace.ToString()))
        );
    ...
    public void RandomThreshold(
        ...
        RandomThreshold(
            PercentageHelper.ToQuantumType(percentageLow),
            PercentageHelper.ToQuantumType(percentageHigh),
            channels
        );
    ...
    public void RangeThreshold(
        ...
        Percentage percentageHighWhite,
        Percentage percentageHighBlack
    ) =>
        RangeThreshold(
            PercentageHelper.ToQuantumType(percentageLowBlack),
            PercentageHelper.ToQuantumType(percentageLowWhite),
            PercentageHelper.ToQuantumType(percentageHighWhite),
            PercentageHelper.ToQuantumType(percentageHighBlack)
        );
    ...
    public void RangeThreshold(
        ...
        QuantumType highWhite,
        QuantumType highBlack
    ...
    public void Read(string fileName, int width, int height)
    {
        ...
        var settings = new MagickReadSettings(_settings) { Width = width, Height = height, };
    ...
    public Task ReadAsync(
        ...
        ReadAsync(
            fileName,
            new MagickReadSettings(_settings) { Format = format },
            cancellationToken
        );
    ...
    )
    {
        ...
        Throw.IfTrue(
            ...
            "The count is {0} but should be at least {1}.",
            count,
            expectedLength
        );

        _nativeInstance.ReadPixels(
            settings.ReadSettings.Width!.Value,
            settings.ReadSettings.Height!.Value,
            settings.Mapping,
            settings.StorageType,
            data,
            offset
    ...
    )
    {
        ...
        Throw.IfTrue(
            nameof(count),
            offset + count > data.Length,
            "The number of items should not exceed the length of the array."
        );
        Throw.IfNull(nameof(settings), settings);
        Throw.IfNullOrEmpty(
            nameof(settings),
    ...
    public void SelectiveBlur(
        ...
        _nativeInstance.SelectiveBlur(
            radius,
            sigma,
            PercentageHelper.ToQuantum(thresholdPercentage),
            channels
        );
    ...
    )
    {
        ...
        Throw.IfTrue(
            nameof(channels),
            !hasRed && !hasGreen && !hasBlue && !hasAlpha,
    ...
    public void SparseColor(
        Channels channels,
        SparseColorMethod method,
        params ISparseColorArg<QuantumType>[] args
    ...
    )
    {
        ...
        var result = _nativeInstance.SubImageSearch(
            ...
            similarityThreshold,
            out var rectangle,
            out var similarityMetric
        );

        var geometry = MagickGeometry.FromRectangle(rectangle);
        return new MagickSearchResult(
            Create(result, GetSettings(image)),
            geometry,
            similarityMetric
        );
    }
    ...
    /// <param name="mode">The color transformation mode.</param>
    /// <returns>True when the colorspace was transformed otherwise false.</returns>
    public bool TransformColorSpace(
        IColorProfile source,
        IColorProfile target,
        ColorTransformMode mode
    )
    {
        Throw.IfNull(nameof(source), source);
        Throw.IfNull(nameof(target), target);
    ...
    public void Trim(Percentage percentBackground)
    {
        ...
        temporaryDefines.SetArtifact(
            ...
            percentBackground.ToInt32().ToString(CultureInfo.InvariantCulture)
        );
        Trim();
    }
    ...
    /// </summary>
    public void WhiteBalance() => _nativeInstance.WhiteBalance();
    ...
    internal static IMagickErrorInfo CreateErrorInfo(MagickImage image) =>
        new MagickErrorInfo(
            image._nativeInstance.MeanErrorPerPixel,
            image._nativeInstance.NormalizedMeanError,
            image._nativeInstance.NormalizedMaximumError
        );

    internal static IReadOnlyCollection<IMagickImage<QuantumType>> CreateList(
        IntPtr images,
        MagickSettings settings
    )
    {
    ...
    internal void SetNext(IMagickImage? image) => _nativeInstance.SetNext(GetInstance(image));
    ...
    private static int GetExpectedLength(IPixelReadSettings<QuantumType> settings)
    {
        Throw.IfNull(
            nameof(settings),
            settings.ReadSettings.Width,
            "ReadSettings.Width should be defined"
        );
        Throw.IfNull(
            nameof(settings),
            settings.ReadSettings.Height,
            "ReadSettings.Height should be defined."
        );

        return settings.ReadSettings.Width.Value
            * settings.ReadSettings.Height.Value
            * settings.Mapping!.Length;
    }
    ...
    private MagickReadSettings CreateReadSettings(IMagickReadSettings<QuantumType>? readSettings)
    {
        if (readSettings is not null && readSettings.FrameCount.HasValue)
            Throw.IfFalse(
                nameof(readSettings),
                readSettings.FrameCount.Value == 1,
    ...
    private void ResetSettings() => _settings.Format = MagickFormat.Unknown;
    ...
    private sealed unsafe partial class NativeMagickImage : NativeInstance
    {
        public void ImportPixels(
            int x,
            int y,
            int width,
            int height,
