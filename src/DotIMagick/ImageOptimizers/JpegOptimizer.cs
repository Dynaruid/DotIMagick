...
public sealed partial class JpegOptimizer : IImageOptimizer
{
    ...
    /// </summary>
    public IMagickFormatInfo Format => MagickFormatInfo.Create(MagickFormat.Jpeg)!;
    ...
    public bool Compress(FileInfo file) => Compress(file, 0);
    ...
    private static void DoNativeCompress(
        string filename,
