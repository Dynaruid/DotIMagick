...
public sealed class GifOptimizer : IImageOptimizer
{
    ...
    /// </summary>
    public IMagickFormatInfo Format => MagickFormatInfo.Create(MagickFormat.Gif)!;
    ...
    public bool Compress(FileInfo file) => LosslessCompress(file);
    ...
    /// <returns>True when the image could be compressed otherwise false.</returns>
    public bool Compress(string fileName) => LosslessCompress(fileName);
    ...
    /// <returns>True when the image could be compressed otherwise false.</returns>
    public bool Compress(Stream stream) => LosslessCompress(stream);
    ...
    private static bool DoLosslessCompress(
