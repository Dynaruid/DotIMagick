...
internal sealed class TemporaryFile : IDisposable
{
    ...
    public TemporaryFile() =>
        _tempFile = new FileInfo(
            Path.Combine(MagickNET.TemporaryDirectory, Guid.NewGuid().ToString())
        );
    ...
    public void CopyTo(TemporaryFile temporaryFile) => CopyTo(temporaryFile._tempFile);
