...
public sealed class SettingsFactory : ISettingsFactory<QuantumType>
{
    ...
    public ICompareSettings<QuantumType> CreateCompareSettings() => new CompareSettings();
    ...
    public IComplexSettings CreateComplexSettings() => new ComplexSettings();
    ...
    public IDeskewSettings CreateDeskewSettings() => new DeskewSettings();
    ...
    public IDistortSettings CreateDistortSettings() => new DistortSettings();
    ...
    public IKmeansSettings CreateKmeansSettings() => new KmeansSettings();
    ...
    public IMagickReadSettings<QuantumType> CreateMagickReadSettings() => new MagickReadSettings();

    /// <summary>
    /// Initializes a new instance that implements <see cref="IMontageSettings{TQuantumType}"/>.
    /// </summary>
    /// <returns>A new <see cref="IMagickReadSettings{TQuantumType}"/> instance.</returns>
    public IMontageSettings<QuantumType> CreateMontageSettings() => new MontageSettings();
    ...
    public IMorphologySettings CreateMorphologySettings() => new MorphologySettings();
    ...
    public IPixelReadSettings<QuantumType> CreatePixelReadSettings() => new PixelReadSettings();
    ...
    public IQuantizeSettings CreateQuantizeSettings() => new QuantizeSettings();
}
