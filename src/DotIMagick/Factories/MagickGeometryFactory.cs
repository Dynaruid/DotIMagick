...
public sealed class MagickGeometryFactory : IMagickGeometryFactory
{
    ...
    public IMagickGeometry Create() => new MagickGeometry();
    ...
    /// <returns>A new <see cref="IMagickGeometry"/> instance.</returns>
    public IMagickGeometry Create(int widthAndHeight) => new MagickGeometry(widthAndHeight);
    ...
    /// <returns>A new <see cref="IMagickGeometry"/> instance.</returns>
    public IMagickGeometry Create(int width, int height) => new MagickGeometry(width, height);
    ...
    /// <returns>A new <see cref="IMagickGeometry"/> instance.</returns>
    public IMagickGeometry Create(string value) => new MagickGeometry(value);
