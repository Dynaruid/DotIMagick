...
public sealed class MatrixFactory : IMatrixFactory
{
    ...
    public IMagickColorMatrix CreateColorMatrix(int order) => new MagickColorMatrix(order);
    ...
    public IConvolveMatrix CreateConvolveMatrix(int order) => new ConvolveMatrix(order);
