...
public partial class MagickNET : IMagickNET
{
    ...
    public static string Version
    {
        get
        {
            ...
            var version = TypeHelper.GetCustomAttribute<AssemblyFileVersionAttribute>(
                typeof(MagickNET)
            );
    ...
    /// Gets the ImageMagick delegate libraries.
    /// </summary>
    string IMagickNET.Delegates => Delegates;
    ...
    /// Gets the information about the supported formats.
    /// </summary>
    IReadOnlyCollection<IMagickFormatInfo> IMagickNET.SupportedFormats => SupportedFormats;

    /// <summary>
    /// Gets the version of Magick.NET.
    /// </summary>
    string IMagickNET.Version => Version;
    ...
    /// Resets the pseudo-random number generator secret key.
    /// </summary>
    void IMagickNET.ResetRandomSeed() => ResetRandomSeed();

    /// <summary>
    /// Set the path to the default font file.
    /// </summary>
    /// <param name="file">The file to use at the default font file.</param>
    void IMagickNET.SetDefaultFontFile(FileInfo file) => SetDefaultFontFile(file);

    /// <summary>
    /// Set the path to the default font file.
    /// </summary>
    /// <param name="fileName">The file name to use at the default font file.</param>
    void IMagickNET.SetDefaultFontFile(string fileName) => SetDefaultFontFile(fileName);
    ...
    /// </summary>
    /// <param name="path">The path of the FontConfig directory.</param>
    void IMagickNET.SetFontConfigDirectory(string path) => SetFontConfigDirectory(path);
    ...
    /// </summary>
    /// <param name="path">The path of the Ghostscript directory.</param>
    void IMagickNET.SetGhostscriptDirectory(string path) => SetGhostscriptDirectory(path);
    ...
    /// </summary>
    /// <param name="path">The path of the Ghostscript font directory.</param>
    void IMagickNET.SetGhostscriptFontDirectory(string path) => SetGhostscriptDirectory(path);
    ...
    void IMagickNET.SetLogEvents(LogEvents events) => SetLogEvents(events);

    /// <summary>
    /// Sets the directory that contains the Native library. This currently only works on Windows.
    /// </summary>
    /// <param name="path">The path of the directory that contains the native library.</param>
    void IMagickNET.SetNativeLibraryDirectory(string path) => SetNativeLibraryDirectory(path);
    ...
    /// </summary>
    /// <param name="path">The path where temp files will be written.</param>
    void IMagickNET.SetTempDirectory(string path) => SetTempDirectory(path);

    /// <summary>
    /// Sets the pseudo-random number generator secret key.
    /// </summary>
    /// <param name="seed">The secret key.</param>
    void IMagickNET.SetRandomSeed(int seed) => SetRandomSeed(seed);
