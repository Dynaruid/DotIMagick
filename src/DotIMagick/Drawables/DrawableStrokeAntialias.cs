...
{
    private DrawableStrokeAntialias(bool isEnabled) => IsEnabled = isEnabled;

    /// <summary>
    /// Gets a new instance of the <see cref="DrawableStrokeAntialias"/> class that is disabled.
    /// </summary>
    public static DrawableStrokeAntialias Disabled => new DrawableStrokeAntialias(false);

    /// <summary>
    /// Gets a new instance of the <see cref="DrawableStrokeAntialias"/> class that is enabled.
    /// </summary>
    public static DrawableStrokeAntialias Enabled => new DrawableStrokeAntialias(true);
