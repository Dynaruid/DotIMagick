...
internal sealed partial class DrawingWand : IDisposable
{
    ...
    public void PathCurveToAbs(PointD controlPointStart, PointD controlPointEnd, PointD endPoint) =>
        _nativeInstance.PathCurveToAbs(
            controlPointStart.X,
            controlPointStart.Y,
            controlPointEnd.X,
            controlPointEnd.Y,
    ...
    public void PathCurveToRel(PointD controlPointStart, PointD controlPointEnd, PointD endPoint) =>
        _nativeInstance.PathCurveToRel(
            controlPointStart.X,
            controlPointStart.Y,
            controlPointEnd.X,
            controlPointEnd.Y,
    ...
    public void PathQuadraticCurveToAbs(PointD controlPoint, PointD endPoint) =>
        _nativeInstance.PathQuadraticCurveToAbs(
            controlPoint.X,
            controlPoint.Y,
            endPoint.X,
            endPoint.Y
    ...
    public void PathQuadraticCurveToRel(PointD controlPoint, PointD endPoint) =>
        _nativeInstance.PathQuadraticCurveToRel(
            controlPoint.X,
            controlPoint.Y,
            endPoint.X,
            endPoint.Y
    ...
    public void PathSmoothCurveToAbs(PointD controlPoint, PointD endPoint) =>
        _nativeInstance.PathSmoothCurveToAbs(
            controlPoint.X,
            controlPoint.Y,
            endPoint.X,
            endPoint.Y
    ...
    public void PathSmoothCurveToRel(PointD controlPoint, PointD endPoint) =>
        _nativeInstance.PathSmoothCurveToRel(
            controlPoint.X,
            controlPoint.Y,
            endPoint.X,
            endPoint.Y
    ...
    public void RoundRectangle(
        ...
        _nativeInstance.RoundRectangle(
            upperLeftX,
            upperLeftY,
            lowerRightX,
            lowerRightY,
