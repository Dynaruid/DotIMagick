...
public sealed partial class Drawables : IDrawables<QuantumType>
{
    ...
    [Obsolete(
        $"This method will be removed in the next major release, use the overload with x, y, width, height, compose instead."
    )]
    public IDrawables<QuantumType> Composite(
        IMagickGeometry offset,
    ...
    /// <returns>The <see cref="Drawables" /> instance.</returns>
    [Obsolete(
        $"This method will be removed in the next major release, use the overload with x, y, compose instead."
    )]
    ...
    public IPaths<QuantumType> Paths() => new Paths(this);
