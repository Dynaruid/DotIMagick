...
public sealed partial class Paths : IPaths<QuantumType>
{
    ...
    /// </summary>
    public Paths() => _paths = new Collection<IPath>();
    ...
    public IPaths<QuantumType> CurveToAbs(
        double x1,
        double y1,
        double x2,
        double y2,
    ...
    /// <param name="y">Y coordinate of the end of the curve.</param>
    /// <returns>The <see cref="Paths" /> instance.</returns>
    public IPaths<QuantumType> CurveToRel(
        double x1,
        double y1,
        double x2,
        double y2,
    ...
    /// <returns>The <see cref="Paths" /> instance.</returns>
    public IPaths<QuantumType> LineToAbs(double x, double y) => LineToAbs(new PointD(x, y));
    ...
    /// <param name="y">The Y coordinate.</param>
    /// <returns>The <see cref="Paths" /> instance.</returns>
    public IPaths<QuantumType> LineToRel(double x, double y) => LineToRel(new PointD(x, y));
    ...
    /// <param name="y">The Y coordinate.</param>
    /// <returns>The <see cref="Paths" /> instance.</returns>
    public IPaths<QuantumType> MoveToAbs(double x, double y) => MoveToAbs(new PointD(x, y));
    ...
    /// <param name="y">The Y coordinate.</param>
    /// <returns>The <see cref="Paths" /> instance.</returns>
    public IPaths<QuantumType> MoveToRel(double x, double y) => MoveToRel(new PointD(x, y));
