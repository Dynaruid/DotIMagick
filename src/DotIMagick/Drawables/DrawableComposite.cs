...
public sealed class DrawableComposite : IDrawableComposite<QuantumType>, IDrawingWand
{
    ...
    [Obsolete(
        $"This constructor will be removed in the next major release, use the overload with x, y, compose instead."
    )]
    ...
    /// <param name="image">The image to draw.</param>
    [Obsolete(
        $"This constructor will be removed in the next major release, use the overload with x, y, width, height, compose instead."
    )]
