...
public sealed class DrawableTextAntialias : IDrawableTextAntialias, IDrawingWand
{
    ...
    /// </summary>
    public static DrawableTextAntialias Disabled => new DrawableTextAntialias(false);

    /// <summary>
    /// Gets a new instance of the <see cref="DrawableTextAntialias"/> class that is enabled.
    /// </summary>
    public static DrawableTextAntialias Enabled => new DrawableTextAntialias(true);
