...
public sealed partial class MagickImageInfoFactory
{
    ...
    public IMagickImageInfo Create(ReadOnlySequence<byte> data) => new MagickImageInfo(data);
    ...
    /// <returns>A new <see cref="IMagickImageInfo"/> instance.</returns>
    /// <exception cref="MagickException">Thrown when an error is raised by ImageMagick.</exception>
    public IMagickImageInfo Create(ReadOnlySpan<byte> data) => new MagickImageInfo(data);
}
