...
{
    public static void RegisterAttributeCodeGenerator<TAttribute, TInfoType>(
        this IncrementalGeneratorInitializationContext context,
        Func<GeneratorAttributeSyntaxContext, TInfoType> transform,
        Action<SourceProductionContext, TInfoType> action
    )
    {
