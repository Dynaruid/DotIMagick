...
public readonly struct Threshold : IEquatable<Threshold>
{
    ...
    public static bool operator ==(Threshold left, Threshold right) => Equals(left, right);
    ...
    public bool Equals(Threshold other) => Minimum == other.Minimum && Maximum == other.Maximum;
