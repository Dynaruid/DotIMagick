...
public sealed class Density : IEquatable<Density?>
{
    ...
    public Density(string value) => Initialize(value);
    ...
    public override bool Equals(object? obj) => Equals(obj as Density);
    ...
    public bool Equals(Density? other)
    {
        ...
        return X == other.X && Y == other.Y && Units == other.Units;
    }
    ...
    public override int GetHashCode() => X.GetHashCode() ^ Y.GetHashCode() ^ Units.GetHashCode();
