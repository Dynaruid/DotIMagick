...
{
    public static ExifValue? Create(ExifTagValue tag) => CreateValue(tag);

    public static ExifValue? Create(ExifTag tag) => CreateValue((ExifTagValue)(ushort)tag);

    public static ExifValue? Create(
        ExifTagValue tag,
    ...
    )
    {
        ...
        {
            ExifDataType.Byte
                => isArray ? new ExifByteArray(tag, dataType) : new ExifByte(tag, dataType),
            ...
            ExifDataType.SignedByte
                => isArray ? new ExifSignedByteArray(tag) : new ExifSignedByte(tag),
            ExifDataType.SignedLong
                => isArray ? new ExifSignedLongArray(tag) : new ExifSignedLong(tag),
            ExifDataType.SignedRational
                => isArray ? new ExifSignedRationalArray(tag) : new ExifSignedRational(tag),
            ExifDataType.SignedShort
                => isArray ? new ExifSignedShortArray(tag) : new ExifSignedShort(tag),
            ExifDataType.String => new ExifString(tag),
            ExifDataType.Undefined
                => isArray ? new ExifByteArray(tag, dataType) : new ExifByte(tag, dataType),
            _ => null,
        };
    }
    ...
    private static ExifValue? CreateValue(ExifTagValue tag) =>
        tag switch
        {
            ...
            ExifTagValue.TIFFEPStandardID
                => new ExifByteArray(ExifTag.TIFFEPStandardID, ExifDataType.Byte),
            ...
            ExifTagValue.JPEGInterchangeFormatLength
                => new ExifLong(ExifTag.JPEGInterchangeFormatLength),
            ExifTagValue.MDFileTag => new ExifLong(ExifTag.MDFileTag),
            ExifTagValue.StandardOutputSensitivity
                => new ExifLong(ExifTag.StandardOutputSensitivity),
            ...
            ExifTagValue.PrimaryChromaticities
                => new ExifRationalArray(ExifTag.PrimaryChromaticities),
            ...
            ExifTagValue.PhotometricInterpretation
                => new ExifShort(ExifTag.PhotometricInterpretation),
            ...
            ExifTagValue.FocalPlaneResolutionUnit2
                => new ExifShort(ExifTag.FocalPlaneResolutionUnit2),
            ...
            ExifTagValue.FocalPlaneResolutionUnit
                => new ExifShort(ExifTag.FocalPlaneResolutionUnit),
            ...
            ExifTagValue.JPEGLosslessPredictors
                => new ExifShortArray(ExifTag.JPEGLosslessPredictors),
            ...
            ExifTagValue.CameraElevationAngle
                => new ExifSignedRational(ExifTag.CameraElevationAngle),
            ...
            ExifTagValue.JPEGTables
                => new ExifByteArray(ExifTag.JPEGTables, ExifDataType.Undefined),
            ExifTagValue.OECF => new ExifByteArray(ExifTag.OECF, ExifDataType.Undefined),
            ExifTagValue.ExifVersion
                => new ExifByteArray(ExifTag.ExifVersion, ExifDataType.Undefined),
            ExifTagValue.ComponentsConfiguration
                => new ExifByteArray(ExifTag.ComponentsConfiguration, ExifDataType.Undefined),
            ExifTagValue.MakerNote => new ExifByteArray(ExifTag.MakerNote, ExifDataType.Undefined),
            ExifTagValue.UserComment
                => new ExifByteArray(ExifTag.UserComment, ExifDataType.Undefined),
            ExifTagValue.FlashpixVersion
                => new ExifByteArray(ExifTag.FlashpixVersion, ExifDataType.Undefined),
            ExifTagValue.SpatialFrequencyResponse
                => new ExifByteArray(ExifTag.SpatialFrequencyResponse, ExifDataType.Undefined),
            ExifTagValue.SpatialFrequencyResponse2
                => new ExifByteArray(ExifTag.SpatialFrequencyResponse2, ExifDataType.Undefined),
            ExifTagValue.Noise => new ExifByteArray(ExifTag.Noise, ExifDataType.Undefined),
            ExifTagValue.CFAPattern
                => new ExifByteArray(ExifTag.CFAPattern, ExifDataType.Undefined),
            ExifTagValue.DeviceSettingDescription
                => new ExifByteArray(ExifTag.DeviceSettingDescription, ExifDataType.Undefined),
            ExifTagValue.ImageSourceData
                => new ExifByteArray(ExifTag.ImageSourceData, ExifDataType.Undefined),
            ExifTagValue.GPSProcessingMethod
                => new ExifByteArray(ExifTag.GPSProcessingMethod, ExifDataType.Undefined),
            ExifTagValue.GPSAreaInformation
                => new ExifByteArray(ExifTag.GPSAreaInformation, ExifDataType.Undefined),
            _ => null,
        };
}
