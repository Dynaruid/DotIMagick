...
internal sealed class ExifWriter
{
    ...
    private static void RemoveOffsetValues(
        Collection<IExifValue> ifdValues,
        params ExifTag[] offsetTags
    )
    {
    ...
    private static uint PositionToOffset(long offset) => (uint)offset - 6;
